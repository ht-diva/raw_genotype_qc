rule create_autosomal_qc_set:
    ...
    output:
        bed=ws_path("autosomal_qc/genotype.bed"),
        bim=ws_path("autosomal_qc/genotype.bim"),
        fam=ws_path("autosomal_qc/genotype.fam"),
    log:
    ...
    resources:
        ...
        mem_mb=16384,
    params:
        bfile=ws_path("sample_missingness/genotype"),
        prefix=ws_path("autosomal_qc/genotype"),
